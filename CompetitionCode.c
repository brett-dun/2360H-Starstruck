...
#pragma config(Motor,  port4,           forklift2,     tmotorVex393_MC29, openLoop)
...
task autonomous() {
	...
	switch(autoChoice) {
		...
		case 3: displayLCDCenteredString(1, "Rightside Autonomous"); right(); break;
	}
...
task usercontrol() {
	...
	while(true) { //Run for the duration of the entire driver control period
		...
		sprintf(secondary, "Secondary: %1.2fV", SensorValue[powerExpander]/182.4);
