...
#pragma config(Motor,  port3,           rightDrive,    tmotorVex393_MC29, openLoop, encoderPort, I2C_4)
#pragma config(Motor,  port6,           leftForklift,  tmotorVex393_MC29, openLoop, reversed, encoderPort, I2C_3)
#pragma config(Motor,  port8,           rightForklift, tmotorVex393_MC29, openLoop)
...
task usercontrol() {
	...
	while(true) {
		...
		if(vexRT[Btn6U]) {
			maxSpeed = 96; //Change the maximum speed to 128 (maximum value)
		} else if(vexRT[Btn6D]) {
